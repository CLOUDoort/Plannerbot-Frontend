            ...
            <div className='flex items-center justify-center w-full h-full'>
                {!submit ?
                    <section className='bg-white/80 z-[9999] border flex flex-col items-center justify-center rounded min-w-[30rem] shadow-2xl w-[50%] h-[80%]'>
                        ...
                        <form onSubmit={handleSubmit(clickSubmit)} className={`${next ? "opacity-100 my-[1rem]" : "opacity-0 -my-[5rem]"} flex transition-all duration-700 w-[1/2] flex-col items-center justify-center px-5 h-[12rem]`}>
